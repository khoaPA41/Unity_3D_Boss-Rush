...
public class PlayerSFX : MonoBehaviour
{
    ...
    [field: Header("Hit Audio Source")]
    [SerializeField] private AudioSource hitSource;
    [field: SerializeField] public AudioResource HitResource { get; private set; }
    ...
    public void PlayHitSound(AudioResource hitSound)
    {
        hitSource.resource = hitSound;
